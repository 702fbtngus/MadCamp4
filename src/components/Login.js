...
const lp = () => {
    ...
    const BookOpen = () => {
        ...
        document.getElementById("record").style.animation = "spin 3s linear infinite running";
        document.getElementById("arm").style.animation = "armwobble 10s ease-in-out infinite running";
        document.getElementById("leftpage").style.animation = "leftpageflip 2s running";
    ...
    const Gujul = () => {
        ...
        document.getElementById("record").style.animation = "spin 3s linear infinite paused";
        document.getElementById("arm").style.animation = "armwobble 10s ease-in-out infinite paused";
        document.getElementById("leftpage").style.animation = "leftpagerevflip 2s running";
        document.getElementById("leftpage").style.animationFillMode = "both";
